...
<form action="<?php echo site_url('admin/home_sec1_update'); ?>" method="post">
              <div class="form-group" >
                    <label>Home Title 1</label>
                    <input type="text" style="width: 45%;" class="form-control" name="title1" id="" aria-describedby="websiteTitle" value="<?php echo $hcon['title1']; ?>" placeholder="Home Title 1">
              </div>
              <div class="form-group" >
                    <label>Home heading 1</label>
                    <input type="text" style="width: 45%;" class="form-control" name="home_heading1" id="" aria-describedby="websiteTitle" value="<?php echo $hcon['home_heading1']; ?>" placeholder="Home heading 1">
              </div>
              <div class="form-group" >
                    <label>Home heading 2</label>
                    <input type="text" style="width: 45%;" class="form-control" name="home_heading2" id="" aria-describedby="websiteTitle" value="<?php echo $hcon['home_heading2']; ?>" placeholder="Home heading 2">
              </div>
 <div class="form-group" >
