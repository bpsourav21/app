...
<html lang="en">
  <head>
	...
	<link href="<?php echo VIEWBASE; ?>admin/css/bootstrap.css" rel="stylesheet">
	<link href="<?php echo VIEWBASE; ?>admin/css/custom.css" rel="stylesheet">
	<link href="<?php echo VIEWBASE; ?>admin/css/bootstrap-responsive.css" rel="stylesheet">
	<script type="text/javascript" src="<?php echo VIEWBASE; ?>admin/js/jquery.latest.js"></script>
	<script type="text/javascript" src="<?php echo VIEWBASE; ?>admin/js/bootstrap.min.js"></script>
	<!--[if lt IE 9]>
